...
# Print the details of a function (NON-TABULAR)
async def print_function_details(func):
    # Extract the function name, visibility, and modifiers from the input argument
    name = func['name']
    ...
    # Print the function name, visibility, modifiers, and file name
    click.echo(f"Function Name: {name}, Visibility: {visibility}, Modifiers: {modifiers}, File Name: {file_name}")
